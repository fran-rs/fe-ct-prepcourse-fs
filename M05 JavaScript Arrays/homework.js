...
function cuentoElementos(array) {
   ...
   // Tu código:
   let cantidadElementosMayor18 = 0;

  for (let i = 0; i < array.length; i++) {
    if (array[i] > 18) {
      cantidadElementosMayor18++;
    }
  }
  return cantidadElementosMayor18;
}
...
function mesesDelAño(array) {
   ...
   if (array.includes("Enero") && array.includes("Marzo") && array.includes("Noviembre")) {
      const mesesEncontrados = array.filter(mes => mes === "Enero" || mes === "Marzo" || mes === "Noviembre");
